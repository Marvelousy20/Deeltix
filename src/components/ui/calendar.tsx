    ...
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          ...
          "h-9 w-9 rounded-md p-0 font-normal bg-transparent"
        ),
        day_range_end: "day-range-end",
        day_selected:
          "bg-neutral-900 text-neutral-50 hover:bg-neutral-900 border-[2px] border-[#FF5C00] hover:text-neutral-50 focus:bg-neutral-900 focus:text-neutral-50 dark:bg-neutral-50 dark:text-neutral-900 dark:hover:bg-neutral-50 dark:hover:text-neutral-900 dark:focus:bg-neutral-50 dark:focus:text-neutral-900",
        day_today:
          "bg-neutral-100 text-neutral-900 dark:bg-neutral-800 border-[2px] rounded-md border-[#FF5C00] dark:text-neutral-50",
        day_outside:
